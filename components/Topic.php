...
use Frontend\Forum\Models\Post as PostModel;
use Frontend\Forum\Models\TopicFollow;
...
class Topic extends ComponentBase
{
    ...
    /**
     * @var Frontend\Forum\Models\Topic Topic cache
     */
    ...
    protected function handleOptOutLinks()
    {
        ...
        if ($action == 'unsubscribe' && $member->user) {
            MailBlocker::addBlock('frontend.forum::mail.topic_reply', $member->user);
    ...
    public function onCreate()
    {
        try {
             ...
             * Extensbility
             */
            Event::fire('frontend.forum.topic.create', [$this, $topic, $topicUrl]);
    ...
    public function onPost()
    {
        try {
             ...
             * Extensbility
             */
            Event::fire('frontend.forum.topic.post', [$this, $post, $postUrl]);
