...
class Member extends ComponentBase
{
    ...
    /**
     * @var Frontend\Forum\Models\Member Other member cache
     */
    ...
    public function componentDetails()
    {
        return [
            'name'        => 'Member',
            'description' => 'Displays forum member information and activity'
        ];
    }
    ...
    {
        return ['topic_reply' => 'frontend.forum::mail.topic_reply'];
    }
    ...
    public function onReport()
    {
        ...
        if ($moderators) {
            ...
            Mail::sendTo($moderators, 'frontend.forum::mail.member_report', $params);
        }
