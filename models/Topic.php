...
class Topic extends Model
{
     ...
     */
    public $hasMany = [
        'posts' => ['Frontend\Forum\Models\Post'],
    ];
     ...
     */
    public $hasOne = [
        'first_post' => ['Frontend\Forum\Models\Post', 'order' => 'created_at asc']
    ];

    public $belongsTo = [
        'channel'          => ['Frontend\Forum\Models\Channel'],
        'start_member'     => ['Frontend\Forum\Models\Member'],
        'last_post'        => ['Frontend\Forum\Models\Post'],
        'last_post_member' => ['Frontend\Forum\Models\Member'],
    ];

    public $belongsToMany = [
        'followers' => ['Frontend\Forum\Models\Member', 'table' => 'forum_topic_followers', 'timestamps' => true]
    ];
